...
var glueHeader = document.getElementById("glue-header");
...
var containerDom = document.getElementsByClassName("lbtContainer")[0];
var ulDom = document.getElementsByClassName("ul-img")[0];
...
window.onscroll = function () {
  ...
  if (scroll > 300) {
    ...
    glueHeader.style.cssText = "display: block;";
    ...
    glueHeader.style.cssText = "display: none;";
...
scrollDown.onclick = function () {
  var sectionIcon = document.getElementById("sectionIcon");
  document.documentElement.scrollTop = sectionIcon.offsetTop;
};
